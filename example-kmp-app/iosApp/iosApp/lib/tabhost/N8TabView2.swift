...
class NavigationPathStore2: ObservableObject {
...
struct N8TabView2Example: View {
    ...
    var body: some View {
        N8TabView2(selection: $selectedTab, tabs: myTabs)
...
struct N8TabView2_Previews: PreviewProvider {
